...
{
    public partial class KedahSeatForm : Form
    {
        ...
        public KedahSeatForm()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    if (flight_purchased == "KLIA2 - LANGKAWI (KEDAH)")
                    {
        ...
        //public string seat_purchased { get; set; }
        //bool change_seat = false;
        private void KedahForm_Load(object sender, EventArgs e)
        {
            /*
                        int size = 0;
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            memberwithoutpurchased.Points += num_of_ticket * 50;
            ...
            flightlist.Add(new MemberWithPurchased(memberwithoutpurchased.Name, memberwithoutpurchased.Ic,
                                                    ...
                                                    "KLIA2 - LANGKAWI (KEDAH)", seat,
                                                    (99 * num_of_ticket), DateTime.Now.ToShortDateString(),
