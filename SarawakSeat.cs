...
{
    public partial class SarawakSeatForm : Form
    {
        ...
        public SarawakSeatForm()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    if (flight_purchased == "KLIA2 - KUCHING (SARAWAK)")
                    {
        ...
        private void SarawakSeatForm_Load(object sender, EventArgs e)
        {
            /*
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            memberwithoutpurchased.Points += num_of_ticket * 100;
            ...
            flightlist.Add(new MemberWithPurchased(memberwithoutpurchased.Name, memberwithoutpurchased.Ic,
                                                    ...
                                                    (199 * num_of_ticket), DateTime.Now.ToShortDateString(),
